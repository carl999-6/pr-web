    ...
    <body>
      ...
      <div class="modal-body">
        <form action="sr_empleado" method="post" class="form-group" >
                ...
                <label for="lbl_numero"><b>Telefono: </b></label>
                <input type="number" name="txt_numero" id="txt_numero" class="form-control" placeholder="Ejemplo 12345678" required>
